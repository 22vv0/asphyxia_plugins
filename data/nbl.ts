...
export const FLAGS7 = [
  ...
  'BEGINNER_MUSIC_FOLDER\t2389,2390,2391,2405,2404',
  'SKILL_ANALYZER_ABLE',
  'BLASTER_ABLE',
  'PREMIUM_TIME_ENABLE',
  'MEGAMIX_ENABLE',
...
export const VALGENE7 = {
  info: [
    ...
    {
      valgene_name: "ヴァルキリージェネレーター 「ホロライブドリームス × BEMANI」",
      valgene_name_english: "Valkyrie Generator (hololive Dreams x BEMANI)",
      valgene_id: 22,
      version: 20260915,
      start: 20260920
    }
  ...
  catalog: [
    ...
    },
    {
      ...
      items: [
        {
          type: 18,
          item_ids: [947, 948, 949, 950, 951, 952, 953, 954, 955, 956, 957, 958, 959, 960, 961, 962, 963, 964]
        }
      ]
    }
  ]
...
export const MEGAMIX_SONGS_5 = [
  ...
  2369, 2383, 2393, 2394, 2395, 2396, 2397, 2388, 2389, 2390,
  2391, 2404, 2405
]
